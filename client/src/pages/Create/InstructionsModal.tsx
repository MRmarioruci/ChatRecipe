...
type PropTypes = {
    data: boolean | Recipe;
	cancel: React.Dispatch<React.SetStateAction<boolean | Recipe>>;
}

function InstructionsModal({data, cancel}: PropTypes) {
				...
				<div className="modal__content">
					<div className="modal__body">
                        <div className="mtop--30">
                            ...
                            <div>
                                <b>Execution</b>
                                <div dangerouslySetInnerHTML={{ __html: data?.execution }}></div>
                            </div>
                        </div>
					</div>
